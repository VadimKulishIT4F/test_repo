...
--по одному эмитенту данные в этих столбцах были типа date, а не boolean как в остальных строках,
...
--а также сделать формат во всех ячейках этих столбцов текстовым
